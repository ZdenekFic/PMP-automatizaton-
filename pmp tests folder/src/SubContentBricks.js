...
exports.SubContentBricks = class SubContentBricks {
  constructor(page,dropdownElement,mainName) {
    ...
    this.subContentBricksTab = page.locator('span').filter({ hasText: 'Sub Content Bricks' }).first();
    ...
    // Search identifiers
    this.generalFormSearchIdentifierRedArrow = page.locator("(//i[@class='v-icon notranslate mdi mdi-upload theme--light'])[2]");
    ...
    this.uniteTypeRedArrowButton = page.locator("(//i[@class='v-icon notranslate mdi mdi-upload theme--light'])[4]");
    this.uniteTypeFirstObject = page.locator("//div[@class='v-dialog v-dialog--active v-dialog--persistent v-dialog--scrollable']//div[@class='v-card v-sheet theme--light']//tbody/tr[2]/td[1]");
    this.uniteTypeFirstUpdateButton = page.locator("//span[normalize-space()='Update Unit Type']");
    this.unitRedArrowButton = page.locator("(//i[@class='v-icon notranslate mdi mdi-upload theme--light'])[5]");
    this.uniteFirstObject = page.locator("//div[@class='v-dialog v-dialog--active v-dialog--persistent v-dialog--scrollable']//div[@class='v-card v-sheet theme--light']//tbody/tr[1]/td[1]");
    this.uniteUpdateButton = page.locator("//span[normalize-space()='Update Unit']");
    ...
    this.saveSCBbutton = page.locator("//div[@class='detail-tab-menu-header-container']//button[2]")
