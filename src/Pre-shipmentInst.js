...
// -------------------------------------------------------------------------------------
exports.PreShipment = class PreShipment {
  constructor(page, dropdownElement, mainName, labelName) {
    this.page = page;
    this.mainName = mainName;

    // --------------------- Navigation Selectors ---------------------
    this.preshipmentTab = '[ui-test-data="nav-testContentBricks-pre-shipment-instructions"]';
  ...
  async enterToPRT() {
    ...
    await this.page.locator(this.preshipmentTab).click();
