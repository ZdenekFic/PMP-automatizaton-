...
// -------------------------------------------------------------------------------------
exports.NormsAndStandarts = class NormsAndStandarts {
  constructor(page, dropdownElement, mainName, labelName) {
    this.page = page;
    this.mainName = mainName;

    // --------------------- Navigation Selectors ---------------------
    this.normsAndStandartsTab = '[ui-test-data="nav-testContentBricks-norms-and-standards"]';
  ...
  async enterToPRT() {
    ...
    await this.page.locator(this.normsAndStandartsTab).click();
